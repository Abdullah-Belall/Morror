  ...
  return (
    <Link href={`/spmovie/${id}`}>
      <div className="mobileCard position-relative main-rounded pointer overflow-hidden w-100 h-100">
        <Image src={`https://image.tmdb.org/t/p/w185${poster}`} fill style={{ objectFit: "cover" }} className="main-rounded position-absolute start-0 top-0 w-100 h-100" alt="no image" />
